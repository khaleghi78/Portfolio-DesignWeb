  ...
  return (
    ...
    <div className='container mx-auto'>
      <div className='flex flex-col items-center text-center'>
        ...
        before:opacity-40 before:-top-[2rem] before:-left-28 before:hidden 
        before:lg:block'>What I do for clients</h2>
        <p className='subtitle'>Like with anything related to JavaScript,
         what a React developer does likely involves the internet and web development in general.
         But the specifics of web development tend to carry a bit more nuance. </p>
      </div>
