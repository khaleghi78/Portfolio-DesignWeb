      ...
      <div className="container mx-auto h-full">
        <div className="flex items-center h-full pt-8">
          <div className="flex-1 flex flex-col items-center lg:items-start">
            <p className="text-lg text-accent mg-[22px]">Hey, I'm zahra</p>
            <h1
              className="text-4xl leading-[44px] md:text-5xl  md:leading-tight
            ...
            text-center lg:text-left">Welcome to my design website.<br /> Thanks for watching ... *.*</p>
